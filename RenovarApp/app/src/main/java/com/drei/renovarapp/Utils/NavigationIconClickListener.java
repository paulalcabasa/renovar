package com.drei.renovarapp.Utils;
...
public class NavigationIconClickListener implements View.OnClickListener{
    ...
    NavigationIconClickListener(Activity context, View sheet) {
        this(context, sheet, null);
    }

    NavigationIconClickListener(Activity context, View sheet, @Nullable Interpolator interpolator) {
        this(context, sheet, interpolator, null, null);
    }

    public NavigationIconClickListener(
            Activity context, View sheet, @Nullable Interpolator interpolator,

//
//  FaceChangedViewController.swift
//  Renovar
//
...
struct Albums {
    ...
    init(id : String,image_url : String,therapy : String) {
...
class FaceChangedViewController: UIViewController ,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cellItem", for: indexPath as IndexPath) as! TherapyGalleryCollectionViewCell
    
        
        cell.albumCoverImage.image = load(fileName: items[indexPath.item].image_url)
        cell.lblTherapyName.text = items[indexPath.item].therapy
        


        cell.albumCoverImage.layer.cornerRadius = 8
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let viewController =
            storyboard.instantiateViewController(withIdentifier: "GalleryViewController") as! GalleryViewController
        
        viewController.therapy = items[indexPath.item].therapy
...
//        }
        ...
        if sqlite3_prepare_v2(db, "SELECT * FROM Gallery GROUP BY therapy", -1, &stmnt, nil) != SQLITE_OK {
...
extension FaceChangedViewController {
